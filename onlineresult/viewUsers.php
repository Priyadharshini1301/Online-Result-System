	...
	<body><br />
		<div align="center">
			...
			<table cellpadding="3" cellspacing="3" class="design" align="center">
				<tr class="labels" style="text-decoration:underline;color:#C60;">
					<th>Sr.No.</th>
					<th>Roll No.</th>
					<th>Name</th>
					<th>Email</th>
				...
				<tr class="labels" style="font-size:14px;color:#3FF;">
					...
					<td>
						<a href="delete.php?del=<?php echo $y['id'];?>" onclick="return confirm('Are You Sure..?');" class="link" style="font-size:14px;">Delete</a>
					</td>
				</tr>
				<?php } ?>
			</table>
