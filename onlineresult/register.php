			...
			<form method="post" action="">
				<table border="0" cellpadding="5" cellspacing="5" class="design">
					...
					<tr>
						...
						<td><input type="text" name="roll" class="fields" required="required" size="15" placeholder="Enter Roll No." /></td>
					</tr>
					<tr>
						<td class="labels">Semester :</td>
						<td><select name="sem" class="fields" style="background-color:#093d3d;" required>
