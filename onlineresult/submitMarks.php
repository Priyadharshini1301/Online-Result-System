			...
			<form method="post" action="">
				<table border="0" cellpadding="5" cellspacing="5" class="design">
					...
					<tr>
						...
						<td><select name="roll" class="fields" style="background-color:#093d3d;" required>
					...
					<tr>
						<td class="labels"><?php echo $y['s1'];?></td>
						<td><input type="text" name="s1" class="fields" size="5" placeholder="20" required="required" /></td>
					</tr>
					<tr>
						<td class="labels"><?php echo $y['s2'];?></td>
						<td><input type="text" name="s2" class="fields" size="5" placeholder="20" required="required" /></td>
					</tr>
					<tr>
						<td class="labels"><?php echo $y['s3'];?></td>
						<td><input type="text" name="s3" class="fields" size="5" placeholder="20" required="required" /></td>
					</tr>
					<tr>
						<td class="labels"><?php echo $y['s4'];?></td>
						<td><input type="text" name="s4" class="fields" size="5" placeholder="20" required="required" /></td>
					</tr>
					<tr>
						<td class="labels"><?php echo $y['s5'];?></td>
						<td><input type="text" name="s5" class="fields" size="5" placeholder="20" required="required" /></td>
					</tr>
					<tr>
						<td colspan="2" align="center"><input type="submit" class="fields" value="Submit" /></td></tr>
				</table>
			</form>
			<br />
			<br />
